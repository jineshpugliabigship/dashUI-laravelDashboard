...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('admin.mastercourierrates.index') }}">Users</a></li>
...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('admin.mastercourierrates.update', $user->id) }}" method="POST" role="form text-left" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    @if($errors->any())
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('admin.mastercourierrates.othersUpdate', $user->id) }}" method="POST" role="form text-left">
                @csrf
                @method('PATCH')
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('admin.mastercourierrates.passUpdate', $user->id) }}" method="POST" role="form text-left">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-6">
